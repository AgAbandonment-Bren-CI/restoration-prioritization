...
ssp2_zs_pu_state <- zonal(pu2, biomes_rast, "sum", na.rm = TRUE)
ssp3_zs_pu_state <- zonal(pu3, biomes_rast, "sum", na.rm = TRUE)
ssp4_zs_pu_state <- zonal(pu4, biomes_rast, "sum", na.rm = TRUE)
ssp5_zs_pu_state <- zonal(pu5, biomes_rast, "sum", na.rm = TRUE)

### find how many pus were *prioritized* in each biome
ssp1_zs_sol_state <- zonal(ssp1_solution, biomes_rast, "sum", na.rm = TRUE)
ssp2_zs_sol_state <- zonal(ssp2_solution, biomes_rast, "sum", na.rm = TRUE)
ssp3_zs_sol_state <- zonal(ssp3_solution, biomes_rast, "sum", na.rm = TRUE)
ssp4_zs_sol_state <- zonal(ssp4_solution, biomes_rast, "sum", na.rm = TRUE)
ssp5_zs_sol_state <- zonal(ssp5_solution, biomes_rast, "sum", na.rm = TRUE)
```
