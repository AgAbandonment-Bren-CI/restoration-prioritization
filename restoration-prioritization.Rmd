...
ssp1_feat <- carbon_bio_pu_mask(carbon_brazil, bio_ext_brazil, ssp1_abandoned_crop)
ssp2_feat <- carbon_bio_pu_mask(carbon_brazil, bio_ext_brazil, ssp2_abandoned_crop)
ssp3_feat <- carbon_bio_pu_mask(carbon_brazil, bio_ext_brazil, ssp3_abandoned_crop)
ssp4_feat <- carbon_bio_pu_mask(carbon_brazil, bio_ext_brazil, ssp4_abandoned_crop)
ssp5_feat <- carbon_bio_pu_mask(carbon_brazil, bio_ext_brazil, ssp5_abandoned_crop)
ssp_all_feat <- carbon_bio_pu_mask(carbon_brazil, bio_ext_brazil, ssp_all_abandoned_crop)
```
...
### Federal unit solutions

Now we will find solutions by breaking the country down by the five Federal Units: North, Northeast, Central-West, Southeast, and South. These units are subnational entities are comprised of several states and hold a degree of self-government and regulation. 
...
NOTE: For total solution, make another solution/problem that uses combined SSP as pus so that there are more connections
