...
## Problem Solving
```{r}
## first solve the prioritizr problems

## SSP1 -----------------------------------------------------

# country-wide low budget
s1_lowB_c <- solve(p1_lowB_c)

# country-wide high budget
s1_highB_c <- solve(p1_highB_c)

eval_target_coverage_summary(p1_lowB_c, s1_lowB_c)
eval_target_coverage_summary(p1_highB_c, s1_highB_c)
...
ssp_all_solution <- rast(s_combo)
crs(ssp_all_solution) = crs(ssp1_abandoned_crop)
names(ssp_all_solution) <- "ssp_all_solution"
writeRaster(ssp_all_solution, "data/outputs/ssp_all_solution.tif", overwrite = TRUE)
```
