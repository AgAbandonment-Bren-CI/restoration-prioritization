...
```{r}
#read in cost data
cost <- read_csv("data/inputs/Brancalion Restoration Cost Data.csv") %>%
  rast("data/inputs/Brancalion Restoration Cost Data.csv")
...
# transform Brazil coordinate reference system to cost raster
# quicker than transforming a global layer
brazil_trans2 <- brazil %>% 
  st_transform(crs = crs(cost))
